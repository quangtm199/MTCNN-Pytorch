...
prefix_path = ''
traindata_store = pathdirect+'/data_set/train'
pnet_model_file = pathdirect+'/data_preprocess/model_store/pnet_epoch.pt'
rnet_model_file = pathdirect+'/data_preprocess/model_store/rnet_epoch.pt'
annotation_file = pathdirect+'/anno_store/anno_train.txt'
